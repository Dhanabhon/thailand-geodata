...
- ค้นหารหัสไปรษณีย์ตามตำบล (ไทย/อังกฤษ) หรือค้นย้อนกลับจากรหัสไปรษณีย์
- รองรับอุปกรณ์มือถือ
...
- แผนที่ choropleth ของ 77 จังหวัด ระบายสีตามจำนวนอำเภอ
- คลิกจังหวัดเพื่อดูสถิติ รายชื่ออำเภอ และรหัสไปรษณีย์ทั้งหมดของจังหวัดนั้น
- Hover แสดง tooltip ภาษาไทย/อังกฤษ พร้อมจำนวนอำเภอ
- ขับเคลื่อนด้วย Leaflet + ขอบเขตจังหวัดจาก `apisit/thailand.json`

### Postal Code Lookup
[GitHub Pages Demo](https://dhanabhon.github.io/thailand-geodata/examples/postal-lookup/)

- เลือกจังหวัด อำเภอ และตำบล เพื่อค้นหารหัสไปรษณีย์
- คัดลอกรหัสไปรษณีย์ไปยัง clipboard ด้วยปุ่มเดียว
- รองรับอุปกรณ์มือถือ
- ใช้งานผ่าน GitHub Pages โดยไม่ต้องติดตั้งอะไร
